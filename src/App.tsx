...
Keep it to 1-2 authoritative sentences.`;
  ...
  // ⚡ Bolt: Cache search query lowercasing and memoize filter logic to prevent O(N) operations on every render.
  // Also using short-circuit evaluation: cheap status check first, expensive string matching last.
