...
Keep it to 1-2 authoritative sentences.`;
  ...
  // Optimization: Memoize the filtered bots list to prevent unnecessary re-computations on every render.
  // Also, cache the lowercase search query outside the filter loop to avoid O(n) redundant allocations.
