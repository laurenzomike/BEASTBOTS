...
Keep it to 1-2 authoritative sentences.`;
  ...
  // Optimization: useMemo caches the result unless dependencies change.
  // Invariant query conversion is extracted out of the filter loop.
  // Short-circuiting the cheap status match before expensive string includes.
