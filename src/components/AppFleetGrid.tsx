...
export const AppFleetGrid: React.FC<AppFleetGridProps> = ({
  ...
  // ⚡ Bolt Performance Optimization: Replace O(N*M) lookup inside render loop with O(N+M) Map.
  const lastActivityMap = React.useMemo(() => {
    const map = new Map<string, string>();
    // Iterate forwards and only set if it doesn't exist, to preserve .find() behavior (which returns the first match)
